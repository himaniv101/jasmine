...
exports.savePatientModels = (req, res, next) => {
  ...
  pReadingModels.baby_investigation_model.create(req.body.baby_investigation)
    .then(result => {
      pReadingModels.patient_model.findOne({
        where: {
          study_id: req.body.baby_appears.study_id
...
exports.getBabyAppearsModel = (req, res, next) => {
  ...
  let query = allQueries.PatientContQueries.getBabyAppearsModel_query();
...
exports.getBabyRespModel = (req, res, next) => {
  ...
  var hospital_id = req.params.hospitalId
  var reading = req.params.readingId
  let query = allQueries.PatientContQueries.getBabyRespModel_query();
  sequelize.query(query,
    {
      replacements: {
        study_id: study_id,
...
exports.getBabyCNSModel = (req, res, next) => {
  ...
  var hospital_id = req.params.hospitalId
  var reading = req.params.readingId
  let query = allQueries.PatientContQueries.getBabyCNSModel_query();
  sequelize.query(query,
    {
      replacements: {
        study_id: study_id,
...
exports.getBabyGITModel = (req, res, next) => {
  ...
  var hospital_id = req.params.hospitalId
  var reading = req.params.readingId
  let query = allQueries.PatientContQueries.getBabyGITModel_query();
  sequelize.query(query,
    {
      replacements: {
        study_id: study_id,
...
exports.getBabyInvestigationModel = (req, res, next) => {
  ...
  var hospital_id = req.params.hospitalId
  var reading = req.params.readingId
  let query = allQueries.PatientContQueries.getBabyInvestigationModel_query();
  sequelize.query(query,
    {
      replacements: {
        study_id: study_id,
...
exports.getBabyAntibioticModel = (req, res, next) => {
  ...
  let query = allQueries.PatientContQueries.getBabyAntibioticModel_query();
  sequelize.query(query,
    {
      replacements: {
        study_id: study_id,
...
exports.getBabyFinalModel = (req, res, next) => {
  ...
  var hospital_id = req.params.hospitalId
  var reading = req.params.readingId
  let query = allQueries.PatientContQueries.getBabyFinalModel_query();
  sequelize.query(query,
    {
      replacements: {
        study_id: study_id,
    ...
    pReadingModels.baby_appear_model.findAll({
      ...
      .then(result => {
        if (result.length == 0) {
          ...
          let query = allQueries.PatientContQueries.searchReadingIdByStudyIdAndMrn_query();
          sequelize.query(query,
...
exports.generateReport = (req, res, next) => {
  ...
  let query = allQueries.PatientContQueries.generateReport_query();
  sequelize.query(query,
    {
      // replacements: { 
...
exports.getBabyMedicalRecord = async (req, res, next) => {
  ...
  if (req.query.searchText == "null") {
    query = allQueries.PatientContQueries.getBabyMedicalRecord_searchTextNull(isStaff, req.params.end, start);
  }
  else {
    query = allQueries.PatientContQueries.getBabyMedicalRecord_searchText(isStaff, req.params.end, start);
  }
...
exports.updateBabyMedicalRecord = (req, res, next) => {
  pReadingModels.basic_model.findOne({
    ...
    .then(patientResult => {
      ...
      patientResult.updated_by = req.params.userTypeConst
...
exports.scoreGeneratedReport = (req, res, next) => {
  ...
  sequelize.query(query,
    ...
    sheet.columns = [
      { header: 'Study Id', key: 'study_id', width: 7 },
      { header: 'Hospital Name', key: 'hospital_name', width: 20 },
      { header: 'Hospital Branch Name', key: 'hospital_branch_name', width: 20 },
      { header: 'Baby Medical Record Number', key: 'baby_medical_record_number', width: 20 },
      { header: 'Baby Mother Medical Record Number', key: 'baby_mother_medical_record_number', width: 20 },
